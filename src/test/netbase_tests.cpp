...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:22015", "127.0.0.1", 22015));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:22015", "127.0.0.1", 22015));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:22015", "::ffff:127.0.0.1", 22015));
    BOOST_CHECK(TestSplitHost("[::]:22015", "::", 22015));
    BOOST_CHECK(TestSplitHost("::22015", "::22015", -1));
    BOOST_CHECK(TestSplitHost(":22015", "", 22015));
    BOOST_CHECK(TestSplitHost("[]:22015", "", 22015));
