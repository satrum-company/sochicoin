...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sochicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"sochicoin.inmean.com", "sochicoin.inmean.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"seed", "seedtest.inmean.com"},
    {"seed2", "seed2.khmer.biz"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sochicoin is probably already running."), addrBind.ToString().c_str());
        else
